 ...
 * 3. [Updating existing installations](#updating-existing-installations)
   * [Updates to code-base only](#updates-to-code-base-only)
   * [Updates to bedevil.h](#updates-to-bedevil.h)
   * [Notes](#notes)
 * 4. [Features & configuration information](#features-configuration-information)
   * [Backdoor utility commands](#backdoor-utility-commands)
   * [Magic GID](#magic-gid)
   * [__HIDE_MY_ASS__](#hide_my_ass)
   * [Backdoors](#backdoors)
     * [PAM backdoor](#pam-backdoor)
     * [Accept hook backdoor](#accept-hook-backdoor)
     * [ICMP backdoor](#icmp-backdoor)
   * [Dynamic linker patching](#dynamic-linker-patching)
   * [File stealing](#file-stealing)
   * [Credential logging](#credential-logging)
   * [Evasion & hiding](#evasion-hiding)
     * [Port hiding](#port-hiding)
     * [Rootkit presence](#rootkit-presence)
